...
class Translations {
	...
	public static function get_frontend_translations() {
		$translations = array(
			...
			'login'                    => esc_html__( 'Log in', 'bookit' ),
			'register'                 => esc_html__( 'Register', 'bookit' ),
			'login_intro'              => esc_html__( 'Already have an account? Log in to continue.', 'bookit' ),
			'login_failed'             => esc_html__( 'The email or password you entered is incorrect.', 'bookit' ),
