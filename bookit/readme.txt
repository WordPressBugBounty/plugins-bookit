...
* Security - Harden the Stripe Connect payment handler.
* Fix - Correct a price-formatting bug affecting some fractional-cents prices.

= 2.6.0.3 2026-08-26 =

* Security - Harden the PayPal payment handler.
